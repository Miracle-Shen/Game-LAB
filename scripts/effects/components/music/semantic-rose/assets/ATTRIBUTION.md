...
`potion-of-spirits.mp4` is a web rendition of Aderrasi - Potion of Spirits from [Stims](https://github.com/zz-plant/stims), released under the Unlicense.

## Live karaoke source

`on-the-run.txt` is the UltraStar-format lyric and pitch chart for **On the run** by Joshua Morin. It was distributed in the [Performous libre song package](https://performous.org/songs).
